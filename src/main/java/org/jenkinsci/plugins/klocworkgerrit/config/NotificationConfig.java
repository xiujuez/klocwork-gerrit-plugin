...
public class NotificationConfig extends AbstractDescribableImpl<NotificationConfig> {
    ...
    * */
    ...
    public static class DescriptorImpl extends Descriptor<NotificationConfig> {
        public static final NotifyHandling NOTIFICATION_RECIPIENT_NO_ISSUES = KlocworkToGerritPublisher.DescriptorImpl.NOTIFICATION_RECIPIENT_NO_ISSUES;
        public static final NotifyHandling NOTIFICATION_RECIPIENT_COMMENTED_ISSUES = KlocworkToGerritPublisher.DescriptorImpl.NOTIFICATION_RECIPIENT_SOME_ISSUES;
        public static final NotifyHandling NOTIFICATION_RECIPIENT_NEGATIVE_SCORE = KlocworkToGerritPublisher.DescriptorImpl.NOTIFICATION_RECIPIENT_NEGATIVE_SCORE;

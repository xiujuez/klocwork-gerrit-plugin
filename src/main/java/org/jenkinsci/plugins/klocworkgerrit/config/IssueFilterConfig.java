...
public class IssueFilterConfig extends AbstractDescribableImpl<IssueFilterConfig> {
    ...
    public static class DescriptorImpl extends Descriptor<IssueFilterConfig> {
        public static final String SEVERITY = KlocworkToGerritPublisher.DescriptorImpl.SEVERITY;
        public static final boolean NEW_ISSUES_ONLY = KlocworkToGerritPublisher.DescriptorImpl.NEW_ISSUES_ONLY;
        public static final boolean CHANGED_LINES_ONLY = KlocworkToGerritPublisher.DescriptorImpl.CHANGED_LINES_ONLY;

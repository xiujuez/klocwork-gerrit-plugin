   ...
   * */
    ...
    * */
    ...
    public static class DescriptorImpl extends Descriptor<ReviewConfig> {
        public static final String NO_ISSUES_TITLE_TEMPLATE = KlocworkToGerritPublisher.DescriptorImpl.NO_ISSUES_TEXT;
        public static final String SOME_ISSUES_TITLE_TEMPLATE = KlocworkToGerritPublisher.DescriptorImpl.SOME_ISSUES_TEXT;
        public static final String ISSUE_COMMENT_TEMPLATE = KlocworkToGerritPublisher.DescriptorImpl.ISSUE_COMMENT_TEXT;

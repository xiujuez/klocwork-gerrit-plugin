...
public class ConfigurationUpdateTest {
        ...
        for (String f : field) {
            ...
            do {
                try {
                    ...
                    if (superclass != null && superclass.getPackage().toString().contains("klocworkgerrit")) {
                        aClass = superclass;
                    } else {
                        throw e;
                    }
    ...
    protected void invokeSetter(KlocworkToGerritPublisher obj, Object value, boolean deprecated, String... fields) throws ReflectiveOperationException {
        if (fields.length == 1){
    ...
    protected KlocworkToGerritPublisher invokeConstructor() throws ReflectiveOperationException {
        Constructor<KlocworkToGerritPublisher> c = KlocworkToGerritPublisher.class.getConstructor();
